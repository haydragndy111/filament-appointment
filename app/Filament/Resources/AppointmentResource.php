    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                ...
                Section::make('Doctor Info')
                    ->schema([
                        TextEntry::make('doctor.name')->label('Name'),
                        TextEntry::make('doctor.phone')->label('Phone'),
                        TextEntry::make('doctor.email')->label('Email'),
                    ])->columns(2),
                Section::make('Pet Info')
                    ->schema([
                        TextEntry::make('pet.name')->label('Name'),
                        TextEntry::make('pet.date_of_birth')->label('Date Of Birth'),
                        TextEntry::make('pet.type')->label('Type'),
                        ImageEntry::make('pet.avatar')
                            ->label('Pet Picture')
                            ->default('/pets/pet-avatar.jpg'),
                    ])->columns(2),
                Section::make('Timing')
                    ->schema([
                        // slot: start
                        ...
                        TextEntry::make('slot.start')->label('start'),
                        TextEntry::make('slot.end')->label('end'),
                        TextEntry::make('slot.status')->label('status'),
                        TextEntry::make('slot.created_at')->label('created_at'),
                        TextEntry::make('slot.schedule.day_of_week')->label('day_of_week'),
                    ])->columns(2),
            ]);
    }
